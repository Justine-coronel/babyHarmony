...
public class mano extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.manos_seccion);
    }
    ...
    public void navigateSettings(View view) {
        Intent intent = new Intent(mano.this,  settings.class);
    ...
    public void onHomeClick(View view) {
        ...
        Intent intent = new Intent(mano.this,  homepagina.class);
        startActivity(intent);
    }
    ...
    public void onAprenderClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(mano.this,  aprenderCli.class);
        startActivity(intent);
    }
    ...
    public void onMiBebeClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(mano.this,  mibebeCli.class);
        startActivity(intent);
    }
    ...
    public void onPerfilClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(mano.this,  perfilCli.class);
        startActivity(intent);
    }
