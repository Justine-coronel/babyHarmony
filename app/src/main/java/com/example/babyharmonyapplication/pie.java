...
public class pie
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pies_seccion);
    }
    ...
    public void navigateSettings(View view) {
        Intent intent = new Intent(pie.this,  settings.class);
    ...
    public void onHomeClick(View view) {
        ...
        Intent intent = new Intent(pie.this,  homepagina.class);
        startActivity(intent);
    }
    ...
    public void onAprenderClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(pie.this,  aprenderCli.class);
        startActivity(intent);
    }
    ...
    public void onMiBebeClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(pie.this,  mibebeCli.class);
        startActivity(intent);
    }
    ...
    public void onPerfilClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(pie.this,  perfilCli.class);
        startActivity(intent);
    }
