...
public class ojos  extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ojos_seccion);
    }
    ...
    public void navigateSettings(View view) {
        Intent intent = new Intent(ojos.this,  settings.class);
    ...
    public void onHomeClick(View view) {
        ...
        Intent intent = new Intent(ojos.this,  homepagina.class);
        startActivity(intent);
    }
    ...
    public void onAprenderClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(ojos.this,  aprenderCli.class);
        startActivity(intent);
    }
    ...
    public void onMiBebeClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(ojos.this,  mibebeCli.class);
        startActivity(intent);
    }
    ...
    public void onPerfilClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(ojos.this,  perfilCli.class);
        startActivity(intent);
    }
