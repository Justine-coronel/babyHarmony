...
public class barriga extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.barriga_seccion);
    }
    ...
    public void navigateSettings(View view) {
        Intent intent = new Intent(barriga.this,  settings.class);
    ...
    public void onHomeClick(View view) {
        ...
        Intent intent = new Intent(barriga.this,  homepagina.class);
        startActivity(intent);
    }
    ...
    public void onAprenderClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(barriga.this,  aprenderCli.class);
        startActivity(intent);
    }
    ...
    public void onMiBebeClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(barriga.this,  mibebeCli.class);
        startActivity(intent);
    }
    ...
    public void onPerfilClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(barriga.this,  perfilCli.class);
        startActivity(intent);
    }
