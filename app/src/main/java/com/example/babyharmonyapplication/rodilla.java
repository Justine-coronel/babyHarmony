...
public class rodilla
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rodilla_seccion);
    }
    ...
    public void navigateSettings(View view) {
        Intent intent = new Intent(rodilla.this,  settings.class);
    ...
    public void onHomeClick(View view) {
        ...
        Intent intent = new Intent(rodilla.this,  homepagina.class);
        startActivity(intent);
    }
    ...
    public void onAprenderClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(rodilla.this,  aprenderCli.class);
        startActivity(intent);
    }
    ...
    public void onMiBebeClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(rodilla.this,  mibebeCli.class);
        startActivity(intent);
    }
    ...
    public void onPerfilClick(View view) {
        resetSelection();
        view.setSelected(true);
        Intent intent = new Intent(rodilla.this,  perfilCli.class);
        startActivity(intent);
    }
